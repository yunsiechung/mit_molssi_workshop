...
project = 'molecool'
copyright = ("2021, Yunsie Chung. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A python package for analyzing and visualizing molecular files. For MolSSI MIT Workshop',
     'Miscellaneous'),
]
